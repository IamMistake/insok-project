    ...
    <x-slot name="header">
        <div class="flex items-center justify-between">
            <div>
                ...
                <h2 class="rr-section-title text-[color:var(--rr-text)] leading-tight">Povtorlivi blokirani termini</h2>
            </div>
            <a href="{{ route('admin.recurring-blocked-periods.create') }}" class="ghost-button !no-underline">
            ...
            <div class="rr-table-wrap">
                <table class="rr-table">
                    ...
                    <tbody class="divide-y [--tw-divide-opacity:1] divide-[color:var(--rr-line)]">
                        @forelse ($blockedPeriods as $blockedPeriod)
                            <tr>
                                ...
                                <td class="text-right text-sm">
                                    <a href="{{ route('admin.recurring-blocked-periods.edit', $blockedPeriod) }}" class="rr-link">Izmeni</a>
                        ...
                        @empty
                            <tr>
                                <td colspan="6" class="px-6 py-8 text-center text-sm rr-muted">Nema definirani povtorlivi blokadi.</td>
                            </tr>
                        @endforelse
                    </tbody>
                </table>
