...
<div class="space-y-4">
    <div>
        <x-input-label for="weekday" value="Day" />
    ...
    <div class="grid gap-4 sm:grid-cols-2">
        ...
        <div>
            <x-input-label for="effective_until" value="Effective until" />
    ...
    <label class="inline-flex items-center gap-2">
        ...
        <span class="text-sm rr-muted">Active recurring block</span>
    </label>
    ...
    <div class="flex items-center gap-3">
        ...
        <a href="{{ route('admin.recurring-blocked-periods.index') }}" class="text-sm rr-link">Back</a>
    </div>
</div>
